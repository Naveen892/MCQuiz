...
export default function result({ route, navigation }) {
    ...
    useEffect(() => {
        if (rq > 3) {
            ...
            setUrl("/home/naveen/MCQuiz/happiness.png");
        }
        else {
            setColor('red');
            setResult('Sorry You Have Failed the exam And got Only ' + rq * 10 + "% marks.");
            setUrl("/home/naveen/MCQuiz/sad.png");
        }
    })
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
             ...
             */}
                    <Image source={rq<=3?require("/home/naveen/MCQuiz/sad.png") : require("/home/naveen/MCQuiz/happiness.png") } style={{height:200,width:200,marginBottom:50}}/>
